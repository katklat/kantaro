...
<main>
    <div class="container text-center">
        ...
        <div class="text-left my-4">
            ...
            <h4>Visit your new list and click on <img class="inline filter-white" src="/images/plus.svg" class="filter-primary inline mt-1 mr-2" width="20" height="20" title="add" alt=""> to add some songs.</h4>
