...
<main>
    ...
    <section class="tools mt-3" <form method="POST" action="{{ route('baskets.update', $basket->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
                ...
                <div class="dropdown__content">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <input type="number" name="year" class="form-control" min="1900" max="2099" step="1" value="{{ old('year') ?? $basket->year }}">
                            </div>
                        </div>
                    </div>
                </div>
